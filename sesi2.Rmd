...
Anda diminta menghitung regresi sederhanan besarnya pengaruh pengeluaran iklan terhadap volume penjualan. Datanya adalah sebagai berikut:
...
```{r eval=requireNamespace("tibble", quietly=TRUE), echo=FALSE}
tibble::as_tibble(iklan)
```
---
