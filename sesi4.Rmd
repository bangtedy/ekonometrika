...
<span style="color:#c391a4">.font150[Perhatikan contoh dan praktekkan cara mendeteksi heteroskedastisitas dengan menggunakan komputer yang ditunjukkan oleh Tutor]</span>
---
...
<span style="color:#91c3b0">.font150[Perhatikan contoh dan praktekkan cara mengatasi heteroskedastisitas dengan menggunakan komputer yang ditunjukkan oleh Tutor]</span>
---
class: middle, center, inverse
...
<span style="color:#91c397">.font150[Perhatikan contoh dan praktekkan cara mendeteksi autokorelasi dengan menggunakan komputer yang ditunjukkan oleh Tutor]</span>
---
...
<span style="color:#c391bd">.font150[Perhatikan contoh dan praktekkan cara mengatasi autokorelasi dengan menggunakan komputer yang ditunjukkan oleh Tutor]</span>
---
...
<span style="color:#f14c1b">.font150[Perhatikan contoh dan praktekkan cara mendeteksi multikolinieritas dengan menggunakan komputer yang ditunjukkan oleh Tutor]</span>
---
...
<span style="color:#1bc0f1">.font150[Perhatikan contoh dan praktekkan cara mengatasi multikolinieritas yang ditunjukkan oleh Tutor]</span>
---
...
<span style="color:#1bc0f1">.font150[Perhatikan contoh dan praktekkan cara menguji normalitas dengan uji Jarque-Bera]</span>

---
# UJI LINIERITAS RAMSEY

<span style="color:#f11b55">.font150[Perhatikan contoh]</span>
